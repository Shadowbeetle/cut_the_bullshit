...
config :cut_the_bullshit,
  ecto_repos: [CutTheBullshit.Repo]

# Configures the endpoint
config :cut_the_bullshit, CutTheBullshitWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [view: CutTheBullshitWeb.ErrorView, accepts: ~w(html json), layout: false],
  pubsub_server: CutTheBullshit.PubSub,
  live_view: [signing_salt: "tFTHwabV"]
